...
class PeminjamPolicy
{
    ...
    {
        return $user->can('view_any_peminjam');
    }
    ...
    {
        return $user->can('create_peminjam');
    }
    ...
    {
        return $user->can('update_peminjam');
    }
    ...
    {
        return $user->can('delete_peminjam');
    }
    ...
    {
        return $user->can('delete_any_peminjam');
    }
